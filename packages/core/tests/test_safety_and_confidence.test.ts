...
import { calculateFactualConfidence, validateIdInheritance } from "../src/coverage";
...
describe.skip("TestFactualConfidence", () => {
  ...
  it("test_full_coverage", () => {
    ...
    try {
      ...
      conn.prepare("INSERT INTO topic_decisions (id, user_confirmed) VALUES (101, 1)").run();
      conn.prepare("INSERT INTO topic_decisions (id, user_confirmed) VALUES (102, 1)").run();
  ...
  it("test_partial_coverage", () => {
    ...
    try {
      ...
      conn.prepare("INSERT INTO topic_decisions (id, user_confirmed) VALUES (101, 1)").run();
      conn.prepare("INSERT INTO topic_decisions (id, user_confirmed) VALUES (102, 0)").run();
  ...
  it("test_validate_id_inheritance_warning", () => {
    ...
    try {
      ...
      conn.prepare("INSERT INTO topic_decisions (id, project_uuid, user_confirmed) VALUES (201, 'p1', 1)").run();
      conn.prepare("INSERT INTO topic_decisions (id, project_uuid, user_confirmed) VALUES (202, 'p1', 1)").run();
